<xaiArtifact artifact_id="8ae7fd06-6047-46f2-a900-a54e49215f85" artifact_version_id="8d124f9b-d861-4b2e-b998-b1718e2d2b7d" title="script.js" contentType="text/javascript">
...
function renderItem(item, isPinned) {
    ...
    if (Array.isArray(item.pictureUrls) && item.pictureUrls.length > 0) {
        imagesHtmlPreview = <div class="item-img-container">                                <img src="${item.pictureUrls[0]}" alt="Preview" class="item-img">                              </div>;
    }
    ...
    itemElement.innerHTML =         <div class="item-actions">             <button class="pin-btn" title="${isPinned ? 'Unpin Item' : 'Pin Item'}">                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="${isPinned ? 'M5 15l7-7 7 7' : 'M12 19V6m0 0l-7 7m7-7l7 7'}" />                 </svg>             </button>             <button class="edit-btn" title="Edit Item">                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />                 </svg>             </button>             <button class="delete-btn" title="Delete Item">                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />                 </svg>             </button>         </div>         <div class="item-content-wrapper" data-id="${item.id}">             ${imagesHtmlPreview}             <p class="item-notes-preview">${notesPreview}</p>             <p class="item-timestamp">${timestampStr}</p>         </div>    ;
